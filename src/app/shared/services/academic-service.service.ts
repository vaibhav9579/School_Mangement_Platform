...
export interface ClassModel { id?: number; institution_id: number; program_id?: number | null; name: string; }
...
export class AcademicServiceService {
  ...
  createClass(c:ClassModel){ return this.http.post<ClassModel>(`${this.base}/classes`, c); }
  updateClass(id:number,c:Partial<ClassModel>){ return this.http.put<ClassModel>(`${this.base}/classes/${id}`, c); }
